...
def virtual_cmd():
	...
	def d2d_cmd():
		...
		launch = roslaunch.parent.ROSLaunchParent(uuid, ["/home/tanmay/catkin_ws/src/gazebo_ros_demos/2d/screen/screen_world.launch"])
		launch.start()
		thread.start_new_thread(os.system, ('python /home/tanmay/catkin_ws/src/ross2cv/src/processor.py',))
		thread.start_new_thread(os.system, ('python /home/tanmay/catkin_ws/src/ross2cv/src/webcam.py',))
		main31 = Tkinter.Tk()
		main31.title('2D World')
		main31.geometry('300x350')
		main31.configure(background='#0000FF')
		main2.withdraw()
		...
		def stop_vis_cmd2():
			os.system("rosnode kill /screen/image_topic")
			os.system("killall -9 gzserver gzclient")	
			main31.withdraw()
			main2.deiconify()
		
		stop_vis2 = Tkinter.Button(main31,text ="Stop Visualisation", command = stop_vis_cmd2 , height=1, width=20,fg= '#000000',bg ='#FFFFFF')
		stop_vis2.pack()
		stop_vis2.place(x=60,y=150)
		back = Tkinter.Button(main31,text ="back", command = back3 , height=1, width=5,fg= '#000000',bg ='#FFFFFF')
		back.pack()
	...
	def d3d_cmd():
		...
		def bag_cmd():
			...
			def existing_bag_cmd():
				...
				def launch_vis_cmd():
					...
					launch.start()
					thread.start_new_thread(os.system, ('rosbag play '+fname,))
				...
				def launch_gmap_cmd():
					...
					thread.start_new_thread(os.system, ('rosrun gmapping slam_gmapping scan:=base_scan',))
					def bag_cmd():
						fname2 = tkFileDialog.askopenfilename(filetypes = (("Bag Files", "*.bag"), ("All files", "*")))
						thread.start_new_thread(os.system, ('rosbag play --clock '+fname2 ,))
					
					def save_cmd():
						thread.start_new_thread(os.system, ('rosrun map_server map_saver -f map',))
					
					bag = Tkinter.Button(main7,text ="select bag file", command = bag_cmd, height=1, width=20,fg= '#000000',bg ='#FFFFFF')
					bag.pack()
					bag.place(x=60,y=125)
					save = Tkinter.Button(main7,text ="save map", command = save_cmd, height=1, width=20,fg= '#000000',bg ='#FFFFFF')
					save.pack()
					save.place(x=60,y=225)
			...
			back = Tkinter.Button(main4,text ="back", command = back5, height=1, width=5,fg= '#000000',bg ='#FFFFFF')
			back.pack()
			back.place(x=10,y=10)
		...
		back = Tkinter.Button(main3,text ="back", command = back4, height=1, width=5,fg= '#000000',bg ='#FFFFFF')
		back.pack()
		back.place(x=10,y=10)
	...
	back = Tkinter.Button(main2,text ="back", command = back2, height=1, width=5,fg= '#000000',bg ='#FFFFFF')
	d2d.pack()
...
def real_cmd():
	thread.start_new_thread(os.system, ('python /home/tanmay/catkin_ws/src/rtabmap_ros/gui3.py',))
	main.withdraw()	
